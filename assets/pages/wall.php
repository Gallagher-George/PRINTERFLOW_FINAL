...
<style>
    <?php include 'assets/bootstrap/css/bootstrap.css';
    ?>
</style>
...
<div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
    <div class="col-md-8 col-sm-12" style="max-width:93vw">
        ...
        <!--MAKING A POST/ATTACHING AN IMAGE/VIDEO---->
            <?php
            ...
            <!--END IMAGE UPLOAD--->
        <!--END MAKING A POST/ATTACHING AN IMAGE/VIDEO---->

        <!--Checking Likes Status on Posts---->
                <span>
                    <?php
        ...
        <!--END Checking Likes Status on Posts---->
                &nbsp;&nbsp;<i class="bi bi-chat-left d-flex align-items-center"><span class="p-1 mx-2 text-small"
                        style="font-size:small" data-bs-toggle="modal" data-bs-target="#postview<?= $post['id'] ?>">
                        ...
                        <div class="col-md-4 col-sm-12 d-flex flex-column">
                            <div class="d-flex align-items-center p-2 border-bottom">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    ...
                                    <p style="margin:0px;" class="text-muted">@<?= $post['username'] ?>
                                    </p>
                                </div>
            ...
            foreach ($likes as $like) {
                ...
                ?>
                                            <li><a class="dropdown-item" href="?u=<?= $lu['username'] ?>">
                                                    <?= $lu['first_name'] . ' ' . $lu['last_name'] ?> (@<?= $lu['username'] ?>)
                                                </a></li>
                                ...
                                <div class="d-flex align-items-center p-2">
                                    ...
                                    <div class="d-flex flex-column justify-content-start align-items-start">
                                        <h6 style="margin: 0px;"><a href="?u=<?= $cuser['username'] ?>"
                                                class="text-decoration-none text-dark text-small text-muted">@
                                                <?= $cuser['username'] ?></a> - <?= $comment['comment'] ?>
                                        </h6>
    ...
    <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
        ...
        <div class="d-flex align-items-center p-2">
            ...
            <div>&nbsp;&nbsp;&nbsp;</div>
            <div class="d-flex flex-column justify-content-center">
                <a href='?u=<?= $user['username'] ?>' class="text-decoration-none text-white">
                    <h6 style="margin: 0px;">
                        <?= $user['first_name'] ?>
                            <?= $user['last_name'] ?>
                    </h6>
                </a>
                <p style="margin:0px;" class="text-white">@<?= $user['username'] ?>
                </p>
            </div>
        </div>
                ...
                <div class="d-flex align-items-center p-2">
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <a href='?u=<?= $suser['username'] ?>' class="text-decoration-none text-white">
                            <h6 style="margin: 0px;font-size: small; color: #ffffff;">
                                <?= $suser['first_name'] ?>
                                    <?= $suser['last_name'] ?>
                            </h6>
                        </a>
                        <p style="margin:0px;font-size:small" class="text-muted">@<?= $suser['username'] ?>
                        </p>
                    </div>
                </div>
                <div class="d-flex align-items-center">
